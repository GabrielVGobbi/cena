        ...
        $.getJSON(BASE_URL + 'ajax/getEtapas/?search=', {
            ...
            if (j.length != 0) {
                for (var i = 0; i < j.length; i++) {
                    ...
                    options += '        <li>';
                    options += '            <div class="icheckbox_flat-blue ' + checked + '" aria-checked="true" aria-disabled="false" style="position: relative;"><input id="checkEtapa" class="flat-blue" type="checkbox"  value="' + id_etapa_obra + '" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div>'

...
<?php include "views/obrasClientes/etapas/editarEtapa.php"; ?>
        ...
        <div class="no-border">
            <ul class="todo-list ">
                <li>
                    ...
                    <a style="cursor: pointer" type="button" data-toggle="modal" data-target="#editarEtapa<?php echo $etp['id_etapa_obra']; ?>" class="collapsed">

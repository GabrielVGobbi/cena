    ...
    <section class="content">
      <div class="error-page">
        ...
        <div class="error-content">
          <h3><i class="fa fa-warning text-yellow"></i> Oops! Página não existe, ou você não tem autorização</h3>

          <p>
            Entre em contato com o administrador do Sistema<br>
            <a href="<?php echo BASE_URL ?>">Retornar ao Dashboard</a> ou pequise um Página!!
          </p>

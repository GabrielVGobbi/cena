                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="box-body" style="">
                                            ...
                                            <?php if($this->user->getId() == 63): ?>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label>Descrição da Etapa</label>
                                                        <textarea type="text" class="form-control" name="descricao" id="descricao" autocomplete="off" rows="5" cols="33"><?php echo $etpCon['descricao']; ?></textarea>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                        </div>

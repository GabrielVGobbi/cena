			...
			<div class="box-tools pull-right">
				<div class="has-feedback">
					...
					<?php if ($this->user->hasPermission('concessionaria_view') && $this->user->hasPermission('concessionaria_add')) : ?>
						<a class="btn btn-sm btn-info pop" href="<?php echo BASE_URL; ?>concessionarias/add">
											...
											<?php foreach ($tableDados as $inf) : ?>
												...
												<tr>
													<td>
														...
														<?php endif; ?>
														<button class="btn btn-danger" data-toggle="popover" title="Remover?" data-content="<a href='<?php echo BASE_URL ?>concessionarias/delete/<?php echo $inf['id'] ?>' class='btn btn-danger'>Sim</a> <button type='button' class='btn btn-default pop-hide'>Não</button>">
